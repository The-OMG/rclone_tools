...
# Example: curl -s https://raw.githubusercontent.com/The-OMG/rclone_tools/master/rclone_move.sh | bash /dev/stdin httpremote: mygsuite:
#
...
_Main() {
  ...
  rclone move "$REMOTE" "$GDRIVE_REMOTE" "${rcloneARGS[@]}" &
